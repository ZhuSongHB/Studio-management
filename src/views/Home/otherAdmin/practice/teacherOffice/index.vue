...
<script>
	...
	import { assumeThesisApplyGetList, acadFeedBackCreditReplaceDatas, assumeThesisSheck, downloadAssumeThesis } from "../../../../../network/api";
	export default {
		props: ["datas"],
		data() {
			return {
		...
		methods: {
			...
			handleCancel(e) {
				...
				acadFeedBackCreditReplaceDatas(obj).then(res => {
					this.$emit("againData");
					this.visible = false;
