...
<script>
	...
	import { creditSchemeGetTable, reguFeedBackCrediReplace, downloadCreditReplaceScheme, creditReplaceSchemeCheck } from "../../../../../network/api";
	export default {
		props: ["datas"],
		data() {
			return {
		...
		methods: {
			...
			handleOk(e) {
				...
				reguFeedBackCrediReplace(obj).then(res => {
					this.$emit("againData");
					this.visible = false;
