...
<script>
	...
	// api接口
	import { manaGetCrediReplace, reguGetCrediReplace, acceptGetCrediReplace, acadGetCrediReplace } from "../../../../network/api";
	export default {
