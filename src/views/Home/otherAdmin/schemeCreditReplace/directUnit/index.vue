...
<script>
	...
	import { creditSchemeGetTable, manaFeedBackCrediReplace, downloadCreditReplaceScheme, creditReplaceSchemeCheck } from "../../../../../network/api";
	export default {
		props: ["datas"],
		data() {
			return {
		...
		methods: {
			...
			handleOk(e) {
				...
				manaFeedBackCrediReplace(obj).then(res => {
					this.$emit("againData");
					this.visible = false;
