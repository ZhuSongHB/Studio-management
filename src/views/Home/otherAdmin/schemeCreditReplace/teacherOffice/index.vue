...
<script>
	...
	import { creditSchemeGetTable, acadFeedBackCrediReplace, downloadCreditReplaceScheme, creditReplaceSchemeCheck } from "../../../../../network/api";
	export default {
		props: ["datas"],
		data() {
			return {
		...
		methods: {
			...
			handleOk(e) {
				...
				acadFeedBackCrediReplace(obj).then(res => {
					this.$emit("againData");
					this.visible = false;
