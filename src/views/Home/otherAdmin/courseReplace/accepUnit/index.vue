...
<script>
	...
	import { courseReplaceApplyGetTable, acceptFeedBackCourseReplaceDatas, courseReplaceCheck, downloadCourseReplace } from "../../../../../network/api";
	export default {
		props: ["datas"],
		data() {
			return {
		...
		methods: {
			...
			handleOk(e) {
				...
				acceptFeedBackCourseReplaceDatas(obj).then(res => {
					this.$emit("againData");
					this.visible = false;
