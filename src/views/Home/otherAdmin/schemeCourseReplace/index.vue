...
<script>
	...
	// api接口
	import { manaGetCourseReplace, reguGetCourseReplace, acceptGetCourseReplace, acadGetCourseReplace } from "../../../../network/api";
	export default {
