...
<script>
	...
	import { courseSchemeGetTable, acceptFeedBackCourseReplace, downloadCourseReplaceScheme, courseReplaceSchemeCheck } from "../../../../../network/api";
	export default {
		props: ["datas"],
		data() {
			return {
		...
		methods: {
			...
			handleOk(e) {
				...
				acceptFeedBackCourseReplace(obj).then(res => {
					this.$emit("againData");
					this.visible = false;
