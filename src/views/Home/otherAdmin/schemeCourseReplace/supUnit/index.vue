...
<script>
	...
	import { courseSchemeGetTable, reguFeedBackCourseReplace, courseReplaceSchemeCheck, downloadCourseReplaceScheme } from "../../../../../network/api";
	export default {
		props: ["datas"],
		data() {
			return {
		...
		methods: {
			...
			handleOk(e) {
				...
				reguFeedBackCourseReplace(obj).then(res => {
					this.$emit("againData");
					this.visible = false;
