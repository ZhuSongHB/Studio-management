...
<script>
	...
	import { assumePracticeApplyTable, acadFeedbackAssumePractice, assumePracticeCheck, downloadAssumePractice } from "../../../../../network/api";
	export default {
		props: ["datas"],
		data() {
			return {
		...
		methods: {
			...
			handleCancel(e) {
				...
				acadFeedbackAssumePractice(obj).then(res => {
					this.$emit("againData");
					this.visible = false;
